...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (!artistId) {
    // Keine Artist‑ID – zurück zum Login
  ...
  fetch(`${API_BASE}/client/${clientId}`)
    ...
    .then((client) => {
      ...
      if (client.finalTemplate) {
        ...
        finalShow.innerHTML = `<h3>Finale Vorlage</h3><img src="${client.finalTemplate.url || client.finalTemplate.path}" alt="Final" style="max-width:100%;height:auto;border-radius:4px;" />`;
